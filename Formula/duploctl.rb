...
class Duploctl < Formula
  ...
  if build.with? "pip"
    ...
    sha256 "535536fb610e6c6c187a3ef6f84b84215d8c464c3a1370744ecc08fc5c39e4ef"
    ...
    on_macos do
      if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
        ...
        sha256 "dd1b5574e607b85959b151bdff9f03340517a2f95cb1f233683e154323b6f039"
      end
      if Hardware::CPU.intel?
        url "#{base_url}/duploctl-#{version}-darwin-amd64.tar.gz"
        sha256 "dba334c23f87f0d5aa2eca1dace14fe131709109de4a2b42b989d579cf18aabd"
      end
    end
    ...
    on_linux do
      if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
        ...
        sha256 "7ec38fe0ae49b080e595a6f58d686235e81a05eafb67cb2f5ff12cba6ad281c2"
      end
      if Hardware::CPU.intel?
        url "#{base_url}/duploctl-#{version}-linux-amd64.tar.gz"
        sha256 "f03af6602a7b9fe1d1083a4d6d4afc2f9341237f3562f0700958935e4dd1ff6e"
      end
    end
